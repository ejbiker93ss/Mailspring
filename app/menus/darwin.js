  ...
  menu: [
    {
      ...
      label: 'SummerMail',
      submenu: [
        { label: localized('About SummerMail'), command: 'application:about' },
        ...
        { type: 'separator' },
        { label: localized('Hide SummerMail'), command: 'application:hide' },
...

    {
      ...
      submenu: [
        { label: localized('SummerMail Help'), command: 'application:view-help' },
        { type: 'separator' },
        { label: localized('Getting Started Guide'), command: 'application:view-getting-started' },
        { label: localized('SummerMail Community'), command: 'application:view-community' },
      ],
    },
  ],
};
