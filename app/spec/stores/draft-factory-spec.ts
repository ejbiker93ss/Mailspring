...
describe('DraftFactory', function draftFactory() {
  beforeEach(() => {
    ...
    fakeMessage1 = new Message({
      ...
      accountId: account.id,
      to: [
        new Contact({ email: 'ben@summermail.com' }),
        new Contact({ email: 'evan@summermail.com' }),
      ],
      cc: [new Contact({ email: 'mg@summermail.com' }), account.me()],
      bcc: [new Contact({ email: 'recruiting@summermail.com' })],
  ...
  describe('creating drafts', () => {
    ...
    describe('createDraftForReply', () => {
      ...
      describe("when the email is CC'd to an alias", () => {
        it('should use the alias as the from address', () => {
          waitsForPromise(() => {
            fakeMessage1.to = [new Contact({ email: 'juan@summermail.com' })];
            fakeMessage1.cc = [
              new Contact({ email: TEST_ACCOUNT_ALIAS_EMAIL }),
              new Contact({ email: 'evan@summermail.com' }),
            ];
    ...
    describe('onComposeForward', () => {
      ...
      it('should include forwarded message text, in a div rather than a blockquote', () => {
        ...
        expect(this.model.body.indexOf('To: ben@summermail.com, evan@summermail.com') > 0).toBe(
          true
        );
        expect(
          this.model.body.indexOf(
            'Cc: mg@summermail.com, SummerMail Test &lt;tester@summermail.com&gt;'
          ) > 0
        ).toBe(true);
      });

      it("should not mention BCC'd recipients in the forwarded message header", () => {
        expect(this.model.body.indexOf('recruiting@summermail.com') > 0).toBe(false);
      });
  ...
  describe('_fromContactForReply', () => {
    it('should work correctly in a range of test cases', () => {
      ...
      const cases = [
        {
          to: [new Contact({ name: 'Ben', email: 'ben@summermail.com' })], // user is not present, must have been BCC'd
          cc: [],
  ...
  describe('createDraftForMailto', () => {
    ...
    describe('should correctly instantiate drafts for a wide range of mailto URLs', () => {
      const links = [
        ...
        'mailto:bengotow@gmail.com',
        'mailto:mg%40summermail.com',
        'mailto:?subject=%1z2a', // fails uriDecode
        'mailto:?subject=%52z2a', // passes uriDecode
        'mailto:?subject=Martha Stewart',
        'mailto:?subject=Martha Stewart&cc=cc@summermail.com',
        'mailto:?subject=Martha Stewart&cc=cc@summermail.com;bengotow@gmail.com',
        'mailto:bengotow@gmail.com&subject=Martha Stewart&cc=cc@summermail.com',
        'mailto:bengotow@gmail.com?subject=Martha%20Stewart&cc=cc@summermail.com&bcc=bcc@summermail.com',
        'mailto:bengotow@gmail.com?subject=Martha%20Stewart&cc=cc@summermail.com&bcc=Ben <bcc@summermail.com>',
        'mailto:bengotow@gmail.com?subject=Martha%20Stewart&cc=cc@summermail.com&bcc=Ben <bcc@summermail.com>;Shawn <shawn@summermail.com>',
        'mailto:Ben Gotow <bengotow@gmail.com>,Shawn <shawn@summermail.com>?subject=Yes this is really valid',
        'mailto:Ben%20Gotow%20<bengotow@gmail.com>,Shawn%20<shawn@summermail.com>?subject=Yes%20this%20is%20really%20valid',
      ...
      const expected = [
        ...
        new Message({
          to: [new Contact({ name: 'mg@summermail.com', email: 'mg@summermail.com' })],
        }),
        new Message({ subject: '%1z2a' }),
        new Message({ subject: 'Rz2a' }),
        new Message({ subject: 'Martha Stewart' }),
        new Message({
          cc: [new Contact({ name: 'cc@summermail.com', email: 'cc@summermail.com' })],
          subject: 'Martha Stewart',
        }),
        new Message({
          cc: [
            new Contact({ name: 'cc@summermail.com', email: 'cc@summermail.com' }),
        ...
        new Message({
          to: [new Contact({ name: 'bengotow@gmail.com', email: 'bengotow@gmail.com' })],
          cc: [new Contact({ name: 'cc@summermail.com', email: 'cc@summermail.com' })],
          bcc: [new Contact({ name: 'bcc@summermail.com', email: 'bcc@summermail.com' })],
          subject: 'Martha Stewart',
        }),
        new Message({
          to: [new Contact({ name: 'bengotow@gmail.com', email: 'bengotow@gmail.com' })],
          cc: [new Contact({ name: 'cc@summermail.com', email: 'cc@summermail.com' })],
          bcc: [new Contact({ name: 'Ben', email: 'bcc@summermail.com' })],
          subject: 'Martha Stewart',
        }),
        new Message({
          to: [new Contact({ name: 'bengotow@gmail.com', email: 'bengotow@gmail.com' })],
          cc: [new Contact({ name: 'cc@summermail.com', email: 'cc@summermail.com' })],
          bcc: [
            new Contact({ name: 'Ben', email: 'bcc@summermail.com' }),
            new Contact({ name: 'Shawn', email: 'shawn@summermail.com' }),
          ],
          subject: 'Martha Stewart',
        }),
        new Message({
