...
describe('marshalMessage', () => {
  ...
  it('is byte-identical to the reference dbus-next output', () => {
    ...
    const expected =
      ...
      '756e6974792f6c61756e63686572656e7472792f73756d6d65726d61696c0000000201730021000000' +
      ...
      '696f6e3a2f2f53756d6d65724d61696c2e6465736b746f7000000000340000000000000005000000636f' +
