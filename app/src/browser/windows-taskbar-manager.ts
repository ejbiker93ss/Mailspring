...
class WindowsTaskbarManager {
   ...
   *
   * Uses mailto: and summermail: protocol URLs so that clicks are routed
      ...
      app.setJumpList([
        {
          ...
          items: [
            ...
            },
            {
              ...
              description: localized('Open SummerMail preferences'),
              program: process.execPath,
              args: 'summermail://open-preferences',
              iconPath: process.execPath,
              iconIndex: 0,
            },
          ],
