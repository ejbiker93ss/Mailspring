...
// API Endpoints
export type SummerMailAPIRequest = typeof import('../flux/summermail-api-request').default;
export const SummerMailAPIRequest: SummerMailAPIRequest;
...
// Testing
export type SummerMailTestUtils = typeof import('../../spec/summermail-test-utils').default;
export const SummerMailTestUtils: SummerMailTestUtils;
