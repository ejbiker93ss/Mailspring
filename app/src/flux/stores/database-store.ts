...
import SummerMailStore from '../../global/summermail-store';
...
/*
Public: SummerMail is built on top of a custom database layer modeled after
...
Section: Database
*/
class DatabaseStore extends SummerMailStore {
  _open = false;
  _waiting = [];
