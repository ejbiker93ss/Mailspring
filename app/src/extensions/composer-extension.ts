import { Message, Contact } from 'summermail-exports';
...
export class ComposerExtension {
  ...
  */
  ...
  //
  // - `iconUrl`: The url of your icon. It should be in the `summermail://`
  // scheme.  For example: `summermail://your-package-name/assets/my-icon@2x.png`.
