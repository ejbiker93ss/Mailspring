...
import { InjectedComponentSet, RetinaImg } from 'summermail-component-kit';
...
const SpinnerImg =
  '<img alt="spinner.gif" src="summermail://message-list/assets/spinner.gif" style="-webkit-user-drag: none;">';
