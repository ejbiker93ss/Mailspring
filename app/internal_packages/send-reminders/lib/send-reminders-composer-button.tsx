...
import { localized, Actions, Message, DraftEditingSession } from 'summermail-exports';
...
> {
  ...
  componentDidUpdate(prevProps: SendRemindersComposerButtonProps) {
    if (prevProps.draft !== this.props.draft && this.state.saving) {
