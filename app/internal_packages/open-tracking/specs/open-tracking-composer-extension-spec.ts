...
const beforeBody = `TEST_BODY <blockquote class="gmail_quote" style="margin:0 0 0 .8ex;border-left:1px #ccc solid;padding-left:1ex;"> On Feb 25 2016, at 3:38 pm, Drew &lt;drew@summermail.com&gt; wrote: <br> twst </blockquote>`;
...
const afterBody = `TEST_BODY <img alt="" src="${PLUGIN_URL}/o/${expectedToken}.png"><blockquote class="gmail_quote" style="margin:0 0 0 .8ex;border-left:1px #ccc solid;padding-left:1ex;"> On Feb 25 2016, at 3:38 pm, Drew &lt;drew@summermail.com&gt; wrote: <br> twst </blockquote>`;
