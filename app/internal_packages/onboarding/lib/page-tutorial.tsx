...
const Steps = [
  {
    ...
    description: localized(
      'SummerMail shows you everything about your contacts right inside your inbox. See LinkedIn profiles, Twitter bios, message history, and more.'
    ),
    x: 96.6,
    y: 1.3,
    xDot: 93.5,
  ...
  },
  {
    ...
    description: localized(
      'With activity tracking, you’ll know as soon as someone reads your message. Sending to a group? SummerMail shows you which recipients opened your email so you can follow up with precision.'
    ),
    x: 12.8,
    y: 1,
    xDot: 15,
  ...
  },
  {
    ...
    description: localized(
      'Snooze emails to return at any time that suits you. Schedule messages to send at the ideal time. SummerMail makes it easy to control the fabric of spacetime!'
    ),
    x: 5.5,
    y: 23.3,
    xDot: 10,
  ...
  //   description: "Embed calendar invitations, propose meeting times, use quick reply templates, send mass emails with mail merge, and more—all directly from SummerMail’s powerful composer.",
  //   x: 60.95,
  //   y: 66,
  //   xDot: 60.3,
  //   yDot: 65.0,
    ...
    return (
      <div className={`page tutorial appeared-${appeared}`}>
        <div className="tutorial-container">
          ...
          <div className="right">
            <img
              src={`summermail://onboarding/assets/${current.image}`}
