...
import fs from 'fs';
import { RetinaImg, Flexbox, ConfigPropContainer } from 'summermail-component-kit';
import { localized, AccountStore, Account } from 'summermail-exports';
  ...
  render() {
    ...
    return (
      <div className="page opaque" style={{ width: 900, height: 620 }}>
        <h1 style={{ paddingTop: 100 }}>{localized(`Welcome to SummerMail`)}</h1>
